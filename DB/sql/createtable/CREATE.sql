-- テーブル作成
SELECT 'SEQ_MAKER_SALES';
CREATE TABLE IF NOT EXISTS SEQ_MAKER_SALES
(
...
SELECT 'SEQ_MAKER_HIST_SALES';
CREATE TABLE IF NOT EXISTS SEQ_MAKER_HIST_SALES
(
  TABLE_NAME  VARCHAR(40)   ,
  ID  INT UNSIGNED  DEFAULT  '0' ,
  WARNING_ID  INT UNSIGNED   ,
...
CREATE TABLE IF NOT EXISTS MINE_MST_SALES
(
...
SELECT 'MINE_MST_HIST_SALES';
CREATE TABLE IF NOT EXISTS MINE_MST_HIST_SALES
(
...
SELECT 'PRODUCT_MST_SALES';
CREATE TABLE IF NOT EXISTS PRODUCT_MST_SALES
(
...
SELECT 'PRODUCT_MST_HIST_SALES';
CREATE TABLE IF NOT EXISTS PRODUCT_MST_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'PRODUCT_CLASS_MST_SALES';
CREATE TABLE IF NOT EXISTS PRODUCT_CLASS_MST_SALES
(
...
SELECT 'PRODUCT_CLASS_MST_HIST_SALES';
CREATE TABLE IF NOT EXISTS PRODUCT_CLASS_MST_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'PRODUCT_SET_MST_SALES';
CREATE TABLE IF NOT EXISTS PRODUCT_SET_MST_SALES
(
...
SELECT 'PRODUCT_SET_MST_HIST_SALES';
CREATE TABLE IF NOT EXISTS PRODUCT_SET_MST_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
CREATE TABLE IF NOT EXISTS RACK_MST_SALES
(
...
SELECT 'RACK_MST_HIST_SALES';
CREATE TABLE IF NOT EXISTS RACK_MST_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'CUSTOMER_MST_SALES';
CREATE TABLE IF NOT EXISTS CUSTOMER_MST_SALES
(
...
SELECT 'CUSTOMER_MST_HIST_SALES';
CREATE TABLE IF NOT EXISTS CUSTOMER_MST_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'DELIVERY_MST_SALES';
CREATE TABLE IF NOT EXISTS DELIVERY_MST_SALES
(
...
SELECT 'DELIVERY_MST_HIST_SALES';
CREATE TABLE IF NOT EXISTS DELIVERY_MST_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'CUSTOMER_REL_SALES';
CREATE TABLE IF NOT EXISTS CUSTOMER_REL_SALES
(
  CUSTOMER_CODE  VARCHAR(15)   ,
  REL_CODE  VARCHAR(15)   ,
...
SELECT 'CUSTOMER_REL_HIST_SALES';
CREATE TABLE IF NOT EXISTS CUSTOMER_REL_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'SUPPLIER_MST_SALES';
CREATE TABLE IF NOT EXISTS SUPPLIER_MST_SALES
(
  SUPPLIER_CODE  VARCHAR(10)   ,
...
SELECT 'SUPPLIER_MST_HIST_SALES';
CREATE TABLE IF NOT EXISTS SUPPLIER_MST_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'ZIP_MST_SALES';
CREATE TABLE IF NOT EXISTS ZIP_MST_SALES
(
...
SELECT 'CATEGORY_MST_SALES';
CREATE TABLE IF NOT EXISTS CATEGORY_MST_SALES
(
...
SELECT 'CATEGORY_TRN_SALES';
CREATE TABLE IF NOT EXISTS CATEGORY_TRN_SALES
(
  CATEGORY_ID  INT UNSIGNED   NOT NULL,
...
SELECT 'CATEGORY_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS CATEGORY_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'TAX_RATE_MST_SALES';
CREATE TABLE IF NOT EXISTS TAX_RATE_MST_SALES
(
...
SELECT 'TAX_RATE_MST_HIST_SALES';
CREATE TABLE IF NOT EXISTS TAX_RATE_MST_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
CREATE TABLE IF NOT EXISTS BANK_MST_SALES
(
...
SELECT 'BANK_MST_HIST_SALES';
CREATE TABLE IF NOT EXISTS BANK_MST_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'INIT_MST_SALES';
CREATE TABLE IF NOT EXISTS INIT_MST_SALES
(
  TABLE_NAME  VARCHAR(40)   ,
...
SELECT 'RATE_MST_SALES';
CREATE TABLE IF NOT EXISTS RATE_MST_SALES
(
...
SELECT 'RATE_MST_HIST_SALES';
CREATE TABLE IF NOT EXISTS RATE_MST_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'RATE_TRN_SALES';
CREATE TABLE IF NOT EXISTS RATE_TRN_SALES
(
  RATE_ID  INT UNSIGNED   NOT NULL,
  START_DATE  DATE   NOT NULL,
  RATE  DECIMAL(8,3)   ,
...
SELECT 'RATE_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS RATE_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'CUSTOMER_RANK_MST_SALES';
CREATE TABLE IF NOT EXISTS CUSTOMER_RANK_MST_SALES
(
...
SELECT 'CUSTOMER_RANK_MST_HIST_SALES';
CREATE TABLE IF NOT EXISTS CUSTOMER_RANK_MST_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'PRODUCT_STOCK_TRN_SALES';
CREATE TABLE IF NOT EXISTS PRODUCT_STOCK_TRN_SALES
(
  RACK_CODE  VARCHAR(10)   ,
...
SELECT 'PRODUCT_STOCK_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS PRODUCT_STOCK_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
CREATE TABLE IF NOT EXISTS ESTIMATE_SHEET_TRN_SALES
(
...
SELECT 'ESTIMATE_SHEET_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS ESTIMATE_SHEET_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'ESTIMATE_LINE_TRN_SALES';
CREATE TABLE IF NOT EXISTS ESTIMATE_LINE_TRN_SALES
(
...
SELECT 'ESTIMATE_LINE_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS ESTIMATE_LINE_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
CREATE TABLE IF NOT EXISTS RO_SLIP_TRN_SALES
(
...
SELECT 'RO_SLIP_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS RO_SLIP_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'RO_LINE_TRN_SALES';
CREATE TABLE IF NOT EXISTS RO_LINE_TRN_SALES
(
...
SELECT 'RO_LINE_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS RO_LINE_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
CREATE TABLE IF NOT EXISTS SALES_SLIP_TRN_SALES
(
...
SELECT 'SALES_SLIP_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS SALES_SLIP_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'SALES_LINE_TRN_SALES';
CREATE TABLE IF NOT EXISTS SALES_LINE_TRN_SALES
(
...
SELECT 'SALES_LINE_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS SALES_LINE_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'PICKING_LIST_TRN_SALES';
CREATE TABLE IF NOT EXISTS PICKING_LIST_TRN_SALES
(
...
SELECT 'PICKING_LIST_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS PICKING_LIST_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'PICKING_LINE_TRN_SALES';
CREATE TABLE IF NOT EXISTS PICKING_LINE_TRN_SALES
(
...
SELECT 'PICKING_LINE_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS PICKING_LINE_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'BILL_TRN_SALES';
CREATE TABLE IF NOT EXISTS BILL_TRN_SALES
(
  BILL_ID  INT UNSIGNED   ,
  STATUS  CHAR(1)   ,
  BILL_YEAR  SMALLINT   ,
...
SELECT 'BILL_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS BILL_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'DEPOSIT_SLIP_TRN_SALES';
CREATE TABLE IF NOT EXISTS DEPOSIT_SLIP_TRN_SALES
(
...
SELECT 'DEPOSIT_SLIP_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS DEPOSIT_SLIP_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'DEPOSIT_LINE_TRN_SALES';
CREATE TABLE IF NOT EXISTS DEPOSIT_LINE_TRN_SALES
(
...
SELECT 'DEPOSIT_LINE_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS DEPOSIT_LINE_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
CREATE TABLE IF NOT EXISTS PO_SLIP_TRN_SALES
(
...
SELECT 'PO_SLIP_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS PO_SLIP_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'PO_LINE_TRN_SALES';
CREATE TABLE IF NOT EXISTS PO_LINE_TRN_SALES
(
...
SELECT 'PO_LINE_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS PO_LINE_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
CREATE TABLE IF NOT EXISTS SUPPLIER_SLIP_TRN_SALES
(
...
SELECT 'SUPPLIER_SLIP_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS SUPPLIER_SLIP_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'SUPPLIER_LINE_TRN_SALES';
CREATE TABLE IF NOT EXISTS SUPPLIER_LINE_TRN_SALES
(
...
SELECT 'SUPPLIER_LINE_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS SUPPLIER_LINE_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'EAD_SLIP_TRN_SALES';
CREATE TABLE IF NOT EXISTS EAD_SLIP_TRN_SALES
(
...
SELECT 'EAD_SLIP_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS EAD_SLIP_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'EAD_LINE_TRN_SALES';
CREATE TABLE IF NOT EXISTS EAD_LINE_TRN_SALES
(
...
SELECT 'EAD_LINE_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS EAD_LINE_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'PAYMENT_SLIP_TRN_SALES';
CREATE TABLE IF NOT EXISTS PAYMENT_SLIP_TRN_SALES
(
  PAYMENT_SLIP_ID  INT UNSIGNED   ,
  STATUS  CHAR(1)   ,
...
SELECT 'PAYMENT_SLIP_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS PAYMENT_SLIP_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'PAYMENT_LINE_TRN_SALES';
CREATE TABLE IF NOT EXISTS PAYMENT_LINE_TRN_SALES
(
  PAYMENT_LINE_ID  INT UNSIGNED   ,
  STATUS  CHAR(1)   ,
  PAYMENT_SLIP_ID  INT UNSIGNED   ,
...
SELECT 'PAYMENT_LINE_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS PAYMENT_LINE_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'ART_BALANCE_TRN_SALES';
CREATE TABLE IF NOT EXISTS ART_BALANCE_TRN_SALES
(
...
SELECT 'ART_BALANCE_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS ART_BALANCE_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'APT_BALANCE_TRN_SALES';
CREATE TABLE IF NOT EXISTS APT_BALANCE_TRN_SALES
(
  APT_BALANCE_ID  INT UNSIGNED   ,
...
SELECT 'APT_BALANCE_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS APT_BALANCE_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'ONLINE_ORDER_WORK_SALES';
CREATE TABLE IF NOT EXISTS ONLINE_ORDER_WORK_SALES
(
  USER_ID  VARCHAR(30)   ,
...
SELECT 'INVOICE_DATA_WORK_SALES';
CREATE TABLE IF NOT EXISTS INVOICE_DATA_WORK_SALES
(
  USER_ID  VARCHAR(30)   ,
...
SELECT 'DELIVERY_DEPOSIT_WORK_SALES';
CREATE TABLE IF NOT EXISTS DELIVERY_DEPOSIT_WORK_SALES
(
  USER_ID  VARCHAR(30)   ,
...
SELECT 'BANK_DEPOSIT_WORK_SALES';
CREATE TABLE IF NOT EXISTS BANK_DEPOSIT_WORK_SALES
(
  USER_ID  VARCHAR(30)   ,
  COLUMN1  VARCHAR(60)   ,
  PAYMENT_DATE  DATE   ,
...
SELECT 'DISCOUNT_MST_SALES';
CREATE TABLE IF NOT EXISTS DISCOUNT_MST_SALES
(
...
SELECT 'DISCOUNT_MST_HIST_SALES';
CREATE TABLE IF NOT EXISTS DISCOUNT_MST_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'DISCOUNT_TRN_SALES';
CREATE TABLE IF NOT EXISTS DISCOUNT_TRN_SALES
(
...
SELECT 'DISCOUNT_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS DISCOUNT_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'DISCOUNT_REL_SALES';
CREATE TABLE IF NOT EXISTS DISCOUNT_REL_SALES
(
  PRODUCT_CODE  VARCHAR(20)   NOT NULL,
  DISCOUNT_ID  VARCHAR(20)   NOT NULL,
  CRE_FUNC  VARCHAR(255)   ,
...
SELECT 'DISCOUNT_REL_HIST_SALES';
CREATE TABLE IF NOT EXISTS DISCOUNT_REL_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'MENU_MST_SALES';
CREATE TABLE IF NOT EXISTS MENU_MST_SALES
(
  MENU_ID  VARCHAR(5)   ,
  CAPTION  VARCHAR(20)   ,
...
SELECT 'REPORT_TEMPLATE_MST_SALES';
CREATE TABLE IF NOT EXISTS REPORT_TEMPLATE_MST_SALES
(
  REPORT_ID  VARCHAR(5)   ,
  DESCRIPTION  VARCHAR(256)   ,
  PATH  VARCHAR(256)   ,
...
SELECT 'DEPT_MST_SALES';
CREATE TABLE IF NOT EXISTS DEPT_MST_SALES
(
  DEPT_ID  VARCHAR(30)   ,
  NAME  VARCHAR(60)   ,
...
SELECT 'DEPT_MST_HIST_SALES';
CREATE TABLE IF NOT EXISTS DEPT_MST_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
CREATE TABLE IF NOT EXISTS USER_MST_SALES
(
  USER_ID  VARCHAR(30)   ,
  NAME_KNJ  VARCHAR(60)   ,
...
SELECT 'USER_MST_HIST_SALES';
CREATE TABLE IF NOT EXISTS USER_MST_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'ROLE_MST_SALES';
CREATE TABLE IF NOT EXISTS ROLE_MST_SALES
(
  ROLE_ID  VARCHAR(30)   ,
  NAME  VARCHAR(60)   ,
  REMARKS  VARCHAR(256)   ,
...
SELECT 'ROLE_CFG_SALES';
CREATE TABLE IF NOT EXISTS ROLE_CFG_SALES
(
  ROLE_ID  VARCHAR(30)   ,
  MENU_ID  VARCHAR(4)   ,
  VALID_FLAG  CHAR(1)   ,
...
SELECT 'GRANT_ROLE_SALES';
CREATE TABLE IF NOT EXISTS GRANT_ROLE_SALES
(
  USER_ID  VARCHAR(30)   ,
  ROLE_ID  VARCHAR(4)   ,
  CRE_FUNC  VARCHAR(255)   ,
...
SELECT 'GRANT_ROLE_HIST_SALES';
CREATE TABLE IF NOT EXISTS GRANT_ROLE_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'DETAIL_DISP_ITEM_MST_SALES';
CREATE TABLE IF NOT EXISTS DETAIL_DISP_ITEM_MST_SALES
(
...
SELECT 'DETAIL_DISP_ITEM_CFG_SALES';
CREATE TABLE IF NOT EXISTS DETAIL_DISP_ITEM_CFG_SALES
(
  USER_ID  VARCHAR(30)   ,
  DETAIL_ID  VARCHAR(10)   ,
  TARGET  CHAR(1)   ,
...
SELECT 'NEWS_MST_SALES';
CREATE TABLE IF NOT EXISTS NEWS_MST_SALES
(
...
SELECT 'SCHEDULE_MST_SALES';
CREATE TABLE IF NOT EXISTS SCHEDULE_MST_SALES
(
...
SELECT 'SCHEDULE_MST_HIST_SALES';
CREATE TABLE IF NOT EXISTS SCHEDULE_MST_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'FILE_INFO_SALES';
CREATE TABLE IF NOT EXISTS FILE_INFO_SALES
(
...
SELECT 'FILE_INFO_HIST_SALES';
CREATE TABLE IF NOT EXISTS FILE_INFO_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'ONLINE_ORDER_REL_SALES';
CREATE TABLE IF NOT EXISTS ONLINE_ORDER_REL_SALES
(
...
SELECT 'ONLINE_ORDER_REL_HIST_SALES';
CREATE TABLE IF NOT EXISTS ONLINE_ORDER_REL_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'DELIVERY_DEPOSIT_REL_SALES';
CREATE TABLE IF NOT EXISTS DELIVERY_DEPOSIT_REL_SALES
(
  SALES_SLIP_ID  INT UNSIGNED   ,
  DEPOSIT_SLIP_ID  INT UNSIGNED   ,
  DELIVERY_SLIP_ID  VARCHAR(12)   ,
...
SELECT 'DELIVERY_DEPOSIT_REL_HIST_SALES';
CREATE TABLE IF NOT EXISTS DELIVERY_DEPOSIT_REL_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'BANK_DEPOSIT_REL_SALES';
CREATE TABLE IF NOT EXISTS BANK_DEPOSIT_REL_SALES
(
  DEPOSIT_SLIP_ID  INT UNSIGNED   ,
  PAYMENT_DATE  DATE   ,
  PAYMENT_NAME  VARCHAR(60)   ,
...
SELECT 'BANK_DEPOSIT_REL_HIST_SALES';
CREATE TABLE IF NOT EXISTS BANK_DEPOSIT_REL_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'CUSTOMER_RANK_SUMMARY_SALES';
CREATE TABLE IF NOT EXISTS CUSTOMER_RANK_SUMMARY_SALES
(
  CUSTOMER_CODE  VARCHAR(15)   ,
  CUSTOMER_NAME  VARCHAR(60)   ,
...
SELECT 'CUSTOMER_SALES_TEMP_SALES';
CREATE TABLE IF NOT EXISTS CUSTOMER_SALES_TEMP_SALES
(
  CUSTOMER_CODE  VARCHAR(15)   ,
  CUSTOMER_NAME  VARCHAR(60)   ,
  CUSTOMER_TEL  CHAR(15)   ,
...
SELECT 'ENTRUST_EAD_SLIP_TRN_SALES';
CREATE TABLE IF NOT EXISTS ENTRUST_EAD_SLIP_TRN_SALES
(
...
SELECT 'ENTRUST_EAD_SLIP_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS ENTRUST_EAD_SLIP_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'ENTRUST_EAD_LINE_TRN_SALES';
CREATE TABLE IF NOT EXISTS ENTRUST_EAD_LINE_TRN_SALES
(
...
SELECT 'ENTRUST_EAD_LINE_TRN_HIST_SALES';
CREATE TABLE IF NOT EXISTS ENTRUST_EAD_LINE_TRN_HIST_SALES
(
  HIST_ID  INT UNSIGNED   ,
  ACTION_TYPE  VARCHAR(20)   ,
  ACTION_FUNC  VARCHAR(255)   ,
...
SELECT 'STDDEV_DATE_WORK_SALES';
CREATE TABLE IF NOT EXISTS STDDEV_DATE_WORK_SALES
(
  SALES_DATE  DATE   ,
  PRIMARY KEY (
    SALES_DATE
...
SELECT 'STDDEV_AGGREGATE_DATA_WORK_SALES';
CREATE TABLE IF NOT EXISTS STDDEV_AGGREGATE_DATA_WORK_SALES
(
  SALES_DATE  DATE   ,
  PRODUCT_CODE  VARCHAR(20)   ,
  QUANTITY  DECIMAL(12,3)   ,
...
SELECT 'STDDEV_YM_WORK_SALES';
CREATE TABLE IF NOT EXISTS STDDEV_YM_WORK_SALES
(
...
SELECT 'STDDEV_AGGREGATE_YM_WORK_SALES';
CREATE TABLE IF NOT EXISTS STDDEV_AGGREGATE_YM_WORK_SALES
(
  SESSION_ID  VARCHAR(255)   ,
  YM  INT   ,
  PRODUCT_CODE  VARCHAR(20)   ,
...
SELECT 'STDDEV_PRODUCT_SALES_YM_WORK_SALES';
CREATE TABLE IF NOT EXISTS STDDEV_PRODUCT_SALES_YM_WORK_SALES
(
  SESSION_ID  VARCHAR(255)   ,
  YM  INT   ,
  PRODUCT_CODE  VARCHAR(20)   ,
...
SELECT 'BILL_OLD_SALES';
CREATE TABLE IF NOT EXISTS BILL_OLD_SALES
(
  BILL_ID  INT UNSIGNED   ,
  STATUS  CHAR(1)   ,
  BILL_YEAR  SMALLINT   ,
...
SELECT 'PASSWORD_MAKER_SALES';
CREATE TABLE IF NOT EXISTS PASSWORD_MAKER_SALES
(
...
CREATE TRIGGER PRODUCT_MST_SALES_DEL AFTER DELETE ON PRODUCT_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('PRODUCT_MST');
...
CREATE TRIGGER PRODUCT_CLASS_MST_SALES_DEL AFTER DELETE ON PRODUCT_CLASS_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('PRODUCT_CLASS_MST');
...
DELIMITER //
SELECT 'PRODUCT_SET_MST_SALES'//
CREATE TRIGGER PRODUCT_SET_MST_SALES_INS AFTER INSERT ON PRODUCT_SET_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.CRE_USER IS NULL OR NEW.CRE_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('PRODUCT_SET_MST');

INSERT INTO PRODUCT_SET_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,SET_PRODUCT_CODE,PRODUCT_CODE,QUANTITY,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.SET_PRODUCT_CODE,NEW.PRODUCT_CODE,NEW.QUANTITY,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER PRODUCT_SET_MST_SALES_UPD AFTER UPDATE ON PRODUCT_SET_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.UPD_USER IS NULL OR NEW.UPD_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('PRODUCT_SET_MST');

INSERT INTO PRODUCT_SET_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,SET_PRODUCT_CODE,PRODUCT_CODE,QUANTITY,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.SET_PRODUCT_CODE,NEW.PRODUCT_CODE,NEW.QUANTITY,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER PRODUCT_SET_MST_SALES_DEL AFTER DELETE ON PRODUCT_SET_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('PRODUCT_SET_MST');

INSERT INTO PRODUCT_SET_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,SET_PRODUCT_CODE,PRODUCT_CODE,QUANTITY,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.SET_PRODUCT_CODE,OLD.PRODUCT_CODE,OLD.QUANTITY,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
...
CREATE TRIGGER CUSTOMER_MST_SALES_DEL AFTER DELETE ON CUSTOMER_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('CUSTOMER_MST');
...
CREATE TRIGGER DELIVERY_MST_SALES_DEL AFTER DELETE ON DELIVERY_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('DELIVERY_MST');
...
DELIMITER //
SELECT 'CUSTOMER_REL_SALES'//
CREATE TRIGGER CUSTOMER_REL_SALES_INS AFTER INSERT ON CUSTOMER_REL_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.CRE_USER IS NULL OR NEW.CRE_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('CUSTOMER_REL');

INSERT INTO CUSTOMER_REL_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,CUSTOMER_CODE,REL_CODE,CUST_REL_CATEGORY,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.CUSTOMER_CODE,NEW.REL_CODE,NEW.CUST_REL_CATEGORY,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER CUSTOMER_REL_SALES_UPD AFTER UPDATE ON CUSTOMER_REL_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.UPD_USER IS NULL OR NEW.UPD_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('CUSTOMER_REL');

INSERT INTO CUSTOMER_REL_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,CUSTOMER_CODE,REL_CODE,CUST_REL_CATEGORY,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.CUSTOMER_CODE,NEW.REL_CODE,NEW.CUST_REL_CATEGORY,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER CUSTOMER_REL_SALES_DEL AFTER DELETE ON CUSTOMER_REL_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('CUSTOMER_REL');

INSERT INTO CUSTOMER_REL_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,CUSTOMER_CODE,REL_CODE,CUST_REL_CATEGORY,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.CUSTOMER_CODE,OLD.REL_CODE,OLD.CUST_REL_CATEGORY,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
...
CREATE TRIGGER SUPPLIER_MST_SALES_DEL AFTER DELETE ON SUPPLIER_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('SUPPLIER_MST');
...
CREATE TRIGGER CATEGORY_TRN_SALES_DEL AFTER DELETE ON CATEGORY_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('CATEGORY_TRN');
...
DELIMITER //
SELECT 'TAX_RATE_MST_SALES'//
CREATE TRIGGER TAX_RATE_MST_SALES_INS AFTER INSERT ON TAX_RATE_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.CRE_USER IS NULL OR NEW.CRE_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('TAX_RATE_MST');

INSERT INTO TAX_RATE_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,TAX_TYPE_CATEGORY,START_DATE,TAX_RATE,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.TAX_TYPE_CATEGORY,NEW.START_DATE,NEW.TAX_RATE,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER TAX_RATE_MST_SALES_UPD AFTER UPDATE ON TAX_RATE_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.UPD_USER IS NULL OR NEW.UPD_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('TAX_RATE_MST');

INSERT INTO TAX_RATE_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,TAX_TYPE_CATEGORY,START_DATE,TAX_RATE,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.TAX_TYPE_CATEGORY,NEW.START_DATE,NEW.TAX_RATE,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER TAX_RATE_MST_SALES_DEL AFTER DELETE ON TAX_RATE_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('TAX_RATE_MST');

INSERT INTO TAX_RATE_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,TAX_TYPE_CATEGORY,START_DATE,TAX_RATE,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.TAX_TYPE_CATEGORY,OLD.START_DATE,OLD.TAX_RATE,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
...
DELIMITER //
SELECT 'RATE_MST_SALES'//
CREATE TRIGGER RATE_MST_SALES_INS AFTER INSERT ON RATE_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.CRE_USER IS NULL OR NEW.CRE_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('RATE_MST');

INSERT INTO RATE_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,RATE_ID,NAME,SIGN,REMARKS,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.RATE_ID,NEW.NAME,NEW.SIGN,NEW.REMARKS,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER RATE_MST_SALES_UPD AFTER UPDATE ON RATE_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.UPD_USER IS NULL OR NEW.UPD_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('RATE_MST');

INSERT INTO RATE_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,RATE_ID,NAME,SIGN,REMARKS,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.RATE_ID,NEW.NAME,NEW.SIGN,NEW.REMARKS,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER RATE_MST_SALES_DEL AFTER DELETE ON RATE_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('RATE_MST');

INSERT INTO RATE_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,RATE_ID,NAME,SIGN,REMARKS,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.RATE_ID,OLD.NAME,OLD.SIGN,OLD.REMARKS,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
...
DELIMITER //
SELECT 'RATE_TRN_SALES'//
CREATE TRIGGER RATE_TRN_SALES_INS AFTER INSERT ON RATE_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.CRE_USER IS NULL OR NEW.CRE_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('RATE_TRN');

INSERT INTO RATE_TRN_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,RATE_ID,START_DATE,RATE,REMARKS,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.RATE_ID,NEW.START_DATE,NEW.RATE,NEW.REMARKS,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER RATE_TRN_SALES_UPD AFTER UPDATE ON RATE_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.UPD_USER IS NULL OR NEW.UPD_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('RATE_TRN');

INSERT INTO RATE_TRN_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,RATE_ID,START_DATE,RATE,REMARKS,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.RATE_ID,NEW.START_DATE,NEW.RATE,NEW.REMARKS,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER RATE_TRN_SALES_DEL AFTER DELETE ON RATE_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('RATE_TRN');

INSERT INTO RATE_TRN_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,RATE_ID,START_DATE,RATE,REMARKS,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.RATE_ID,OLD.START_DATE,OLD.RATE,OLD.REMARKS,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
...
CREATE TRIGGER CUSTOMER_RANK_MST_SALES_DEL AFTER DELETE ON CUSTOMER_RANK_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('CUSTOMER_RANK_MST');
...
DELIMITER //
SELECT 'PRODUCT_STOCK_TRN_SALES'//
CREATE TRIGGER PRODUCT_STOCK_TRN_SALES_INS AFTER INSERT ON PRODUCT_STOCK_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.CRE_USER IS NULL OR NEW.CRE_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('PRODUCT_STOCK_TRN');

INSERT INTO PRODUCT_STOCK_TRN_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,RACK_CODE,PRODUCT_CODE,STOCK_PDATE,STOCK_ANNUAL,STOCK_MONTHLY,STOCK_YM,STOCK_NUM,ENTER_NUM,DISPATCH_NUM,REMARKS,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.RACK_CODE,NEW.PRODUCT_CODE,NEW.STOCK_PDATE,NEW.STOCK_ANNUAL,NEW.STOCK_MONTHLY,NEW.STOCK_YM,NEW.STOCK_NUM,NEW.ENTER_NUM,NEW.DISPATCH_NUM,NEW.REMARKS,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER PRODUCT_STOCK_TRN_SALES_UPD AFTER UPDATE ON PRODUCT_STOCK_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.UPD_USER IS NULL OR NEW.UPD_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('PRODUCT_STOCK_TRN');

INSERT INTO PRODUCT_STOCK_TRN_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,RACK_CODE,PRODUCT_CODE,STOCK_PDATE,STOCK_ANNUAL,STOCK_MONTHLY,STOCK_YM,STOCK_NUM,ENTER_NUM,DISPATCH_NUM,REMARKS,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.RACK_CODE,NEW.PRODUCT_CODE,NEW.STOCK_PDATE,NEW.STOCK_ANNUAL,NEW.STOCK_MONTHLY,NEW.STOCK_YM,NEW.STOCK_NUM,NEW.ENTER_NUM,NEW.DISPATCH_NUM,NEW.REMARKS,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER PRODUCT_STOCK_TRN_SALES_DEL AFTER DELETE ON PRODUCT_STOCK_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('PRODUCT_STOCK_TRN');

INSERT INTO PRODUCT_STOCK_TRN_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,RACK_CODE,PRODUCT_CODE,STOCK_PDATE,STOCK_ANNUAL,STOCK_MONTHLY,STOCK_YM,STOCK_NUM,ENTER_NUM,DISPATCH_NUM,REMARKS,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.RACK_CODE,OLD.PRODUCT_CODE,OLD.STOCK_PDATE,OLD.STOCK_ANNUAL,OLD.STOCK_MONTHLY,OLD.STOCK_YM,OLD.STOCK_NUM,OLD.ENTER_NUM,OLD.DISPATCH_NUM,OLD.REMARKS,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
...
CREATE TRIGGER ESTIMATE_LINE_TRN_SALES_DEL AFTER DELETE ON ESTIMATE_LINE_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('ESTIMATE_LINE_TRN');
...
CREATE TRIGGER RO_LINE_TRN_SALES_DEL AFTER DELETE ON RO_LINE_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('RO_LINE_TRN');
...
CREATE TRIGGER SALES_LINE_TRN_SALES_DEL AFTER DELETE ON SALES_LINE_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('SALES_LINE_TRN');
...
CREATE TRIGGER PICKING_LIST_TRN_SALES_DEL AFTER DELETE ON PICKING_LIST_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('PICKING_LIST_TRN');
...
CREATE TRIGGER PICKING_LINE_TRN_SALES_DEL AFTER DELETE ON PICKING_LINE_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('PICKING_LINE_TRN');
...
CREATE TRIGGER BILL_TRN_SALES_DEL AFTER DELETE ON BILL_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('BILL_TRN');
...
CREATE TRIGGER DEPOSIT_SLIP_TRN_SALES_DEL AFTER DELETE ON DEPOSIT_SLIP_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('DEPOSIT_SLIP_TRN');
...
CREATE TRIGGER DEPOSIT_LINE_TRN_SALES_DEL AFTER DELETE ON DEPOSIT_LINE_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('DEPOSIT_LINE_TRN');
...
CREATE TRIGGER PO_LINE_TRN_SALES_DEL AFTER DELETE ON PO_LINE_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('PO_LINE_TRN');
...
CREATE TRIGGER SUPPLIER_LINE_TRN_SALES_DEL AFTER DELETE ON SUPPLIER_LINE_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('SUPPLIER_LINE_TRN');
...
DELIMITER //
SELECT 'EAD_SLIP_TRN_SALES'//
CREATE TRIGGER EAD_SLIP_TRN_SALES_INS AFTER INSERT ON EAD_SLIP_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.CRE_USER IS NULL OR NEW.CRE_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('EAD_SLIP_TRN');

INSERT INTO EAD_SLIP_TRN_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,EAD_SLIP_ID,EAD_DATE,EAD_ANNUAL,EAD_MONTHLY,EAD_YM,USER_ID,USER_NAME,EAD_SLIP_CATEGORY,EAD_CATEGORY,REMARKS,SRC_FUNC,SALES_SLIP_ID,SUPPLIER_SLIP_ID,MOVE_DEPOSIT_SLIP_ID,STOCK_PDATE,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.EAD_SLIP_ID,NEW.EAD_DATE,NEW.EAD_ANNUAL,NEW.EAD_MONTHLY,NEW.EAD_YM,NEW.USER_ID,NEW.USER_NAME,NEW.EAD_SLIP_CATEGORY,NEW.EAD_CATEGORY,NEW.REMARKS,NEW.SRC_FUNC,NEW.SALES_SLIP_ID,NEW.SUPPLIER_SLIP_ID,NEW.MOVE_DEPOSIT_SLIP_ID,NEW.STOCK_PDATE,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER EAD_SLIP_TRN_SALES_UPD AFTER UPDATE ON EAD_SLIP_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.UPD_USER IS NULL OR NEW.UPD_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('EAD_SLIP_TRN');

INSERT INTO EAD_SLIP_TRN_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,EAD_SLIP_ID,EAD_DATE,EAD_ANNUAL,EAD_MONTHLY,EAD_YM,USER_ID,USER_NAME,EAD_SLIP_CATEGORY,EAD_CATEGORY,REMARKS,SRC_FUNC,SALES_SLIP_ID,SUPPLIER_SLIP_ID,MOVE_DEPOSIT_SLIP_ID,STOCK_PDATE,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.EAD_SLIP_ID,NEW.EAD_DATE,NEW.EAD_ANNUAL,NEW.EAD_MONTHLY,NEW.EAD_YM,NEW.USER_ID,NEW.USER_NAME,NEW.EAD_SLIP_CATEGORY,NEW.EAD_CATEGORY,NEW.REMARKS,NEW.SRC_FUNC,NEW.SALES_SLIP_ID,NEW.SUPPLIER_SLIP_ID,NEW.MOVE_DEPOSIT_SLIP_ID,NEW.STOCK_PDATE,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER EAD_SLIP_TRN_SALES_DEL AFTER DELETE ON EAD_SLIP_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('EAD_SLIP_TRN');

INSERT INTO EAD_SLIP_TRN_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,EAD_SLIP_ID,EAD_DATE,EAD_ANNUAL,EAD_MONTHLY,EAD_YM,USER_ID,USER_NAME,EAD_SLIP_CATEGORY,EAD_CATEGORY,REMARKS,SRC_FUNC,SALES_SLIP_ID,SUPPLIER_SLIP_ID,MOVE_DEPOSIT_SLIP_ID,STOCK_PDATE,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.EAD_SLIP_ID,OLD.EAD_DATE,OLD.EAD_ANNUAL,OLD.EAD_MONTHLY,OLD.EAD_YM,OLD.USER_ID,OLD.USER_NAME,OLD.EAD_SLIP_CATEGORY,OLD.EAD_CATEGORY,OLD.REMARKS,OLD.SRC_FUNC,OLD.SALES_SLIP_ID,OLD.SUPPLIER_SLIP_ID,OLD.MOVE_DEPOSIT_SLIP_ID,OLD.STOCK_PDATE,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
...
CREATE TRIGGER EAD_LINE_TRN_SALES_DEL AFTER DELETE ON EAD_LINE_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('EAD_LINE_TRN');
...
CREATE TRIGGER PAYMENT_SLIP_TRN_SALES_DEL AFTER DELETE ON PAYMENT_SLIP_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('PAYMENT_SLIP_TRN');
...
CREATE TRIGGER PAYMENT_LINE_TRN_SALES_DEL AFTER DELETE ON PAYMENT_LINE_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('PAYMENT_LINE_TRN');
...
CREATE TRIGGER ART_BALANCE_TRN_SALES_DEL AFTER DELETE ON ART_BALANCE_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('ART_BALANCE_TRN');
...
CREATE TRIGGER APT_BALANCE_TRN_SALES_DEL AFTER DELETE ON APT_BALANCE_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('APT_BALANCE_TRN');
...
CREATE TRIGGER DISCOUNT_MST_SALES_DEL AFTER DELETE ON DISCOUNT_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('DISCOUNT_MST');
...
CREATE TRIGGER DISCOUNT_TRN_SALES_DEL AFTER DELETE ON DISCOUNT_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('DISCOUNT_TRN');
...
DELIMITER //
SELECT 'DISCOUNT_REL_SALES'//
CREATE TRIGGER DISCOUNT_REL_SALES_INS AFTER INSERT ON DISCOUNT_REL_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.CRE_USER IS NULL OR NEW.CRE_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('DISCOUNT_REL');

INSERT INTO DISCOUNT_REL_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,PRODUCT_CODE,DISCOUNT_ID,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.PRODUCT_CODE,NEW.DISCOUNT_ID,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER DISCOUNT_REL_SALES_UPD AFTER UPDATE ON DISCOUNT_REL_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.UPD_USER IS NULL OR NEW.UPD_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('DISCOUNT_REL');

INSERT INTO DISCOUNT_REL_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,PRODUCT_CODE,DISCOUNT_ID,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.PRODUCT_CODE,NEW.DISCOUNT_ID,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER DISCOUNT_REL_SALES_DEL AFTER DELETE ON DISCOUNT_REL_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('DISCOUNT_REL');

INSERT INTO DISCOUNT_REL_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,PRODUCT_CODE,DISCOUNT_ID,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.PRODUCT_CODE,OLD.DISCOUNT_ID,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
...
DELIMITER //
SELECT 'DEPT_MST_SALES'//
CREATE TRIGGER DEPT_MST_SALES_INS AFTER INSERT ON DEPT_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.CRE_USER IS NULL OR NEW.CRE_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('DEPT_MST');

INSERT INTO DEPT_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,DEPT_ID,NAME,PARENT_ID,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.DEPT_ID,NEW.NAME,NEW.PARENT_ID,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER DEPT_MST_SALES_UPD AFTER UPDATE ON DEPT_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.UPD_USER IS NULL OR NEW.UPD_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('DEPT_MST');

INSERT INTO DEPT_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,DEPT_ID,NAME,PARENT_ID,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.DEPT_ID,NEW.NAME,NEW.PARENT_ID,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER DEPT_MST_SALES_DEL AFTER DELETE ON DEPT_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('DEPT_MST');

INSERT INTO DEPT_MST_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,DEPT_ID,NAME,PARENT_ID,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.DEPT_ID,OLD.NAME,OLD.PARENT_ID,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
...
DELIMITER //
SELECT 'GRANT_ROLE_SALES'//
CREATE TRIGGER GRANT_ROLE_SALES_INS AFTER INSERT ON GRANT_ROLE_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.CRE_USER IS NULL OR NEW.CRE_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('GRANT_ROLE');

INSERT INTO GRANT_ROLE_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,USER_ID,ROLE_ID,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.USER_ID,NEW.ROLE_ID,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER GRANT_ROLE_SALES_UPD AFTER UPDATE ON GRANT_ROLE_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.UPD_USER IS NULL OR NEW.UPD_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('GRANT_ROLE');

INSERT INTO GRANT_ROLE_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,USER_ID,ROLE_ID,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.USER_ID,NEW.ROLE_ID,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER GRANT_ROLE_SALES_DEL AFTER DELETE ON GRANT_ROLE_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('GRANT_ROLE');

INSERT INTO GRANT_ROLE_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,USER_ID,ROLE_ID,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.USER_ID,OLD.ROLE_ID,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
...
CREATE TRIGGER SCHEDULE_MST_SALES_DEL AFTER DELETE ON SCHEDULE_MST_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('SCHEDULE_MST');
...
CREATE TRIGGER FILE_INFO_SALES_DEL AFTER DELETE ON FILE_INFO_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('FILE_INFO');
...
DELIMITER //
SELECT 'ONLINE_ORDER_REL_SALES'//
CREATE TRIGGER ONLINE_ORDER_REL_SALES_INS AFTER INSERT ON ONLINE_ORDER_REL_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.CRE_USER IS NULL OR NEW.CRE_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('ONLINE_ORDER_REL');

INSERT INTO ONLINE_ORDER_REL_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,RO_SLIP_ID,RO_LINE_ID,ONLINE_ORDER_ID,ONLINE_ITEM_ID,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.RO_SLIP_ID,NEW.RO_LINE_ID,NEW.ONLINE_ORDER_ID,NEW.ONLINE_ITEM_ID,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER ONLINE_ORDER_REL_SALES_UPD AFTER UPDATE ON ONLINE_ORDER_REL_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.UPD_USER IS NULL OR NEW.UPD_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('ONLINE_ORDER_REL');

INSERT INTO ONLINE_ORDER_REL_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,RO_SLIP_ID,RO_LINE_ID,ONLINE_ORDER_ID,ONLINE_ITEM_ID,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.RO_SLIP_ID,NEW.RO_LINE_ID,NEW.ONLINE_ORDER_ID,NEW.ONLINE_ITEM_ID,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER ONLINE_ORDER_REL_SALES_DEL AFTER DELETE ON ONLINE_ORDER_REL_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('ONLINE_ORDER_REL');

INSERT INTO ONLINE_ORDER_REL_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,RO_SLIP_ID,RO_LINE_ID,ONLINE_ORDER_ID,ONLINE_ITEM_ID,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.RO_SLIP_ID,OLD.RO_LINE_ID,OLD.ONLINE_ORDER_ID,OLD.ONLINE_ITEM_ID,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
...
DELIMITER //
SELECT 'DELIVERY_DEPOSIT_REL_SALES'//
CREATE TRIGGER DELIVERY_DEPOSIT_REL_SALES_INS AFTER INSERT ON DELIVERY_DEPOSIT_REL_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.CRE_USER IS NULL OR NEW.CRE_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('DELIVERY_DEPOSIT_REL');

INSERT INTO DELIVERY_DEPOSIT_REL_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,SALES_SLIP_ID,DEPOSIT_SLIP_ID,DELIVERY_SLIP_ID,DATA_CATEGORY,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.SALES_SLIP_ID,NEW.DEPOSIT_SLIP_ID,NEW.DELIVERY_SLIP_ID,NEW.DATA_CATEGORY,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER DELIVERY_DEPOSIT_REL_SALES_UPD AFTER UPDATE ON DELIVERY_DEPOSIT_REL_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.UPD_USER IS NULL OR NEW.UPD_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('DELIVERY_DEPOSIT_REL');

INSERT INTO DELIVERY_DEPOSIT_REL_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,SALES_SLIP_ID,DEPOSIT_SLIP_ID,DELIVERY_SLIP_ID,DATA_CATEGORY,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.SALES_SLIP_ID,NEW.DEPOSIT_SLIP_ID,NEW.DELIVERY_SLIP_ID,NEW.DATA_CATEGORY,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER DELIVERY_DEPOSIT_REL_SALES_DEL AFTER DELETE ON DELIVERY_DEPOSIT_REL_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('DELIVERY_DEPOSIT_REL');

INSERT INTO DELIVERY_DEPOSIT_REL_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,SALES_SLIP_ID,DEPOSIT_SLIP_ID,DELIVERY_SLIP_ID,DATA_CATEGORY,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.SALES_SLIP_ID,OLD.DEPOSIT_SLIP_ID,OLD.DELIVERY_SLIP_ID,OLD.DATA_CATEGORY,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
...
DELIMITER //
SELECT 'BANK_DEPOSIT_REL_SALES'//
CREATE TRIGGER BANK_DEPOSIT_REL_SALES_INS AFTER INSERT ON BANK_DEPOSIT_REL_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.CRE_USER IS NULL OR NEW.CRE_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('BANK_DEPOSIT_REL');

INSERT INTO BANK_DEPOSIT_REL_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,DEPOSIT_SLIP_ID,PAYMENT_DATE,PAYMENT_NAME,LINE_NO,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.DEPOSIT_SLIP_ID,NEW.PAYMENT_DATE,NEW.PAYMENT_NAME,NEW.LINE_NO,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER BANK_DEPOSIT_REL_SALES_UPD AFTER UPDATE ON BANK_DEPOSIT_REL_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.UPD_USER IS NULL OR NEW.UPD_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('BANK_DEPOSIT_REL');

INSERT INTO BANK_DEPOSIT_REL_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,DEPOSIT_SLIP_ID,PAYMENT_DATE,PAYMENT_NAME,LINE_NO,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.DEPOSIT_SLIP_ID,NEW.PAYMENT_DATE,NEW.PAYMENT_NAME,NEW.LINE_NO,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER BANK_DEPOSIT_REL_SALES_DEL AFTER DELETE ON BANK_DEPOSIT_REL_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('BANK_DEPOSIT_REL');

INSERT INTO BANK_DEPOSIT_REL_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,DEPOSIT_SLIP_ID,PAYMENT_DATE,PAYMENT_NAME,LINE_NO,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.DEPOSIT_SLIP_ID,OLD.PAYMENT_DATE,OLD.PAYMENT_NAME,OLD.LINE_NO,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
...
DELIMITER //
SELECT 'ENTRUST_EAD_SLIP_TRN_SALES'//
CREATE TRIGGER ENTRUST_EAD_SLIP_TRN_SALES_INS AFTER INSERT ON ENTRUST_EAD_SLIP_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.CRE_USER IS NULL OR NEW.CRE_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('ENTRUST_EAD_SLIP_TRN');

INSERT INTO ENTRUST_EAD_SLIP_TRN_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,ENTRUST_EAD_SLIP_ID,ENTRUST_EAD_DATE,ENTRUST_EAD_ANNUAL,ENTRUST_EAD_MONTHLY,ENTRUST_EAD_YM,USER_ID,USER_NAME,ENTRUST_EAD_CATEGORY,REMARKS,PO_SLIP_ID,DISPATCH_ORDER_PRINT_COUNT,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.ENTRUST_EAD_SLIP_ID,NEW.ENTRUST_EAD_DATE,NEW.ENTRUST_EAD_ANNUAL,NEW.ENTRUST_EAD_MONTHLY,NEW.ENTRUST_EAD_YM,NEW.USER_ID,NEW.USER_NAME,NEW.ENTRUST_EAD_CATEGORY,NEW.REMARKS,NEW.PO_SLIP_ID,NEW.DISPATCH_ORDER_PRINT_COUNT,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER ENTRUST_EAD_SLIP_TRN_SALES_UPD AFTER UPDATE ON ENTRUST_EAD_SLIP_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.UPD_USER IS NULL OR NEW.UPD_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('ENTRUST_EAD_SLIP_TRN');

INSERT INTO ENTRUST_EAD_SLIP_TRN_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,ENTRUST_EAD_SLIP_ID,ENTRUST_EAD_DATE,ENTRUST_EAD_ANNUAL,ENTRUST_EAD_MONTHLY,ENTRUST_EAD_YM,USER_ID,USER_NAME,ENTRUST_EAD_CATEGORY,REMARKS,PO_SLIP_ID,DISPATCH_ORDER_PRINT_COUNT,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.ENTRUST_EAD_SLIP_ID,NEW.ENTRUST_EAD_DATE,NEW.ENTRUST_EAD_ANNUAL,NEW.ENTRUST_EAD_MONTHLY,NEW.ENTRUST_EAD_YM,NEW.USER_ID,NEW.USER_NAME,NEW.ENTRUST_EAD_CATEGORY,NEW.REMARKS,NEW.PO_SLIP_ID,NEW.DISPATCH_ORDER_PRINT_COUNT,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER ENTRUST_EAD_SLIP_TRN_SALES_DEL AFTER DELETE ON ENTRUST_EAD_SLIP_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('ENTRUST_EAD_SLIP_TRN');

INSERT INTO ENTRUST_EAD_SLIP_TRN_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,ENTRUST_EAD_SLIP_ID,ENTRUST_EAD_DATE,ENTRUST_EAD_ANNUAL,ENTRUST_EAD_MONTHLY,ENTRUST_EAD_YM,USER_ID,USER_NAME,ENTRUST_EAD_CATEGORY,REMARKS,PO_SLIP_ID,DISPATCH_ORDER_PRINT_COUNT,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.ENTRUST_EAD_SLIP_ID,OLD.ENTRUST_EAD_DATE,OLD.ENTRUST_EAD_ANNUAL,OLD.ENTRUST_EAD_MONTHLY,OLD.ENTRUST_EAD_YM,OLD.USER_ID,OLD.USER_NAME,OLD.ENTRUST_EAD_CATEGORY,OLD.REMARKS,OLD.PO_SLIP_ID,OLD.DISPATCH_ORDER_PRINT_COUNT,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
...
DELIMITER //
SELECT 'ENTRUST_EAD_LINE_TRN_SALES'//
CREATE TRIGGER ENTRUST_EAD_LINE_TRN_SALES_INS AFTER INSERT ON ENTRUST_EAD_LINE_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.CRE_USER IS NULL OR NEW.CRE_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('ENTRUST_EAD_LINE_TRN');

INSERT INTO ENTRUST_EAD_LINE_TRN_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,ENTRUST_EAD_LINE_ID,ENTRUST_EAD_SLIP_ID,LINE_NO,PRODUCT_CODE,PRODUCT_ABSTRACT,QUANTITY,REMARKS,PO_LINE_ID,REL_ENTRUST_EAD_LINE_ID,ENTRUST_EAD_CATEGORY,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER,NEW.ENTRUST_EAD_LINE_ID,NEW.ENTRUST_EAD_SLIP_ID,NEW.LINE_NO,NEW.PRODUCT_CODE,NEW.PRODUCT_ABSTRACT,NEW.QUANTITY,NEW.REMARKS,NEW.PO_LINE_ID,NEW.REL_ENTRUST_EAD_LINE_ID,NEW.ENTRUST_EAD_CATEGORY,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER ENTRUST_EAD_LINE_TRN_SALES_UPD AFTER UPDATE ON ENTRUST_EAD_LINE_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF NEW.UPD_USER IS NULL OR NEW.UPD_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('ENTRUST_EAD_LINE_TRN');

INSERT INTO ENTRUST_EAD_LINE_TRN_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,ENTRUST_EAD_LINE_ID,ENTRUST_EAD_SLIP_ID,LINE_NO,PRODUCT_CODE,PRODUCT_ABSTRACT,QUANTITY,REMARKS,PO_LINE_ID,REL_ENTRUST_EAD_LINE_ID,ENTRUST_EAD_CATEGORY,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'UPDATE', NEW.UPD_FUNC, now(), NEW.UPD_USER,NEW.ENTRUST_EAD_LINE_ID,NEW.ENTRUST_EAD_SLIP_ID,NEW.LINE_NO,NEW.PRODUCT_CODE,NEW.PRODUCT_ABSTRACT,NEW.QUANTITY,NEW.REMARKS,NEW.PO_LINE_ID,NEW.REL_ENTRUST_EAD_LINE_ID,NEW.ENTRUST_EAD_CATEGORY,NEW.CRE_FUNC,NEW.CRE_DATETM,NEW.CRE_USER,NEW.UPD_FUNC,NEW.UPD_DATETM,NEW.UPD_USER,NEW.DEL_FUNC,NEW.DEL_DATETM,NEW.DEL_USER);
END IF;

END//

CREATE TRIGGER ENTRUST_EAD_LINE_TRN_SALES_DEL AFTER DELETE ON ENTRUST_EAD_LINE_TRN_SALES FOR EACH ROW BEGIN
DECLARE histId INT UNSIGNED DEFAULT 0;
IF OLD.DEL_USER IS NULL OR OLD.DEL_USER <> 'NOLOG' THEN
SET histId = GET_NEXT_VAL_HIST('ENTRUST_EAD_LINE_TRN');

INSERT INTO ENTRUST_EAD_LINE_TRN_HIST_SALES(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,ENTRUST_EAD_LINE_ID,ENTRUST_EAD_SLIP_ID,LINE_NO,PRODUCT_CODE,PRODUCT_ABSTRACT,QUANTITY,REMARKS,PO_LINE_ID,REL_ENTRUST_EAD_LINE_ID,ENTRUST_EAD_CATEGORY,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'DELETE', OLD.DEL_FUNC, now(), OLD.DEL_USER,OLD.ENTRUST_EAD_LINE_ID,OLD.ENTRUST_EAD_SLIP_ID,OLD.LINE_NO,OLD.PRODUCT_CODE,OLD.PRODUCT_ABSTRACT,OLD.QUANTITY,OLD.REMARKS,OLD.PO_LINE_ID,OLD.REL_ENTRUST_EAD_LINE_ID,OLD.ENTRUST_EAD_CATEGORY,OLD.CRE_FUNC,OLD.CRE_DATETM,OLD.CRE_USER,OLD.UPD_FUNC,OLD.UPD_DATETM,OLD.UPD_USER,OLD.DEL_FUNC,OLD.DEL_DATETM,OLD.DEL_USER);
END IF;
...
CREATE INDEX USER_ID ON ONLINE_ORDER_WORK_SALES(USER_ID);
CREATE INDEX SET_PRODUCT_CODE ON PRODUCT_SET_MST_SALES(SET_PRODUCT_CODE);
CREATE INDEX PRODUCT_CODE ON PRODUCT_SET_MST_SALES(PRODUCT_CODE);
CREATE INDEX OPEN_LEVEL ON FILE_INFO_SALES(OPEN_LEVEL);
CREATE INDEX USER_ID ON USER_MST_SALES(USER_ID);
CREATE INDEX DEPT_ID ON USER_MST_SALES(DEPT_ID);
CREATE INDEX UPD_DATETM ON USER_MST_HIST_SALES(UPD_DATETM);
CREATE INDEX CRE_DATETM ON USER_MST_HIST_SALES(CRE_DATETM);
CREATE INDEX RATE_ID ON RATE_TRN_SALES(RATE_ID);
CREATE INDEX START_DATE ON RATE_TRN_SALES(START_DATE);
CREATE INDEX MENU_ID ON ROLE_CFG_SALES(MENU_ID);
CREATE INDEX ROLE_ID ON ROLE_CFG_SALES(ROLE_ID);
CREATE INDEX USER_ID ON GRANT_ROLE_SALES(USER_ID);
CREATE INDEX DISCOUNT_ID ON DISCOUNT_MST_SALES(DISCOUNT_ID);
CREATE INDEX BANK_CODE ON BANK_MST_SALES(BANK_CODE);
CREATE INDEX ACCOUNT_NUM ON BANK_MST_SALES(ACCOUNT_NUM);
CREATE INDEX STORE_CODE ON BANK_MST_SALES(STORE_CODE);
CREATE INDEX USER_ID ON ESTIMATE_SHEET_TRN_SALES(USER_ID);
CREATE INDEX VALID_DATE ON ESTIMATE_SHEET_TRN_SALES(VALID_DATE);
CREATE INDEX ESTIMATE_SHEET_ID ON ESTIMATE_SHEET_TRN_SALES(ESTIMATE_SHEET_ID);
CREATE INDEX ESTIMATE_DATE ON ESTIMATE_SHEET_TRN_SALES(ESTIMATE_DATE);
CREATE INDEX CUSTOMER_CODE ON ESTIMATE_SHEET_TRN_SALES(CUSTOMER_CODE);
CREATE INDEX ESTIMATE_DATE ON ESTIMATE_SHEET_TRN_HIST_SALES(ESTIMATE_DATE);
CREATE INDEX UPD_DATETM ON ESTIMATE_SHEET_TRN_HIST_SALES(UPD_DATETM);
CREATE INDEX SUPPLIER_CODE ON SUPPLIER_MST_SALES(SUPPLIER_CODE);
CREATE INDEX UPD_DATETM ON SUPPLIER_MST_HIST_SALES(UPD_DATETM);
CREATE INDEX CRE_DATETM ON SUPPLIER_MST_HIST_SALES(CRE_DATETM);
CREATE INDEX SUPPLIER_CODE ON SUPPLIER_MST_HIST_SALES(SUPPLIER_CODE);
CREATE INDEX SUPPLIER_CODE ON SUPPLIER_SLIP_TRN_SALES(SUPPLIER_CODE);
CREATE INDEX SUPPLIER_SLIP_ID ON SUPPLIER_SLIP_TRN_SALES(SUPPLIER_SLIP_ID);
CREATE INDEX SUPPLIER_DATE ON SUPPLIER_SLIP_TRN_SALES(SUPPLIER_DATE);
CREATE INDEX PO_SLIP_ID ON SUPPLIER_SLIP_TRN_SALES(PO_SLIP_ID);
CREATE INDEX UPD_DATETM ON SUPPLIER_SLIP_TRN_HIST_SALES(UPD_DATETM);
CREATE INDEX SUPPLIER_CODE ON SUPPLIER_SLIP_TRN_HIST_SALES(SUPPLIER_CODE);
CREATE INDEX DELIVERY_DATE ON SUPPLIER_SLIP_TRN_HIST_SALES(DELIVERY_DATE);
CREATE INDEX PRODUCT_CODE ON SUPPLIER_LINE_TRN_SALES(PRODUCT_CODE);
CREATE INDEX PO_LINE_ID ON SUPPLIER_LINE_TRN_SALES(PO_LINE_ID);
CREATE INDEX PRODUCT_CODE ON SUPPLIER_LINE_TRN_HIST_SALES(PRODUCT_CODE);
CREATE INDEX PO_SLIP_ID ON PAYMENT_SLIP_TRN_SALES(PO_SLIP_ID);
CREATE INDEX SUPPLIER_CODE ON PAYMENT_SLIP_TRN_SALES(SUPPLIER_CODE);
CREATE INDEX SUPPLIER_SLIP_ID ON PAYMENT_SLIP_TRN_SALES(SUPPLIER_SLIP_ID);
CREATE INDEX PAYMENT_CUTOFF_DATE ON PAYMENT_SLIP_TRN_SALES(PAYMENT_CUTOFF_DATE);
CREATE INDEX PAYMENT_SLIP_ID ON PAYMENT_SLIP_TRN_SALES(PAYMENT_SLIP_ID);
CREATE INDEX PAYMENT_DATE ON PAYMENT_SLIP_TRN_SALES(PAYMENT_DATE);
CREATE INDEX UPD_DATETM ON PAYMENT_SLIP_TRN_HIST_SALES(UPD_DATETM);
CREATE INDEX SUPPLIER_CODE ON PAYMENT_SLIP_TRN_HIST_SALES(SUPPLIER_CODE);
CREATE INDEX PAYMENT_DATE ON PAYMENT_SLIP_TRN_HIST_SALES(PAYMENT_DATE);
CREATE INDEX PRODUCT_CODE ON PAYMENT_LINE_TRN_SALES(PRODUCT_CODE);
CREATE INDEX SUPPLIER_LINE_ID ON PAYMENT_LINE_TRN_SALES(SUPPLIER_LINE_ID);
CREATE INDEX RO_SLIP_ID ON RO_SLIP_TRN_SALES(RO_SLIP_ID);
CREATE INDEX RO_DATE ON RO_SLIP_TRN_SALES(RO_DATE);
CREATE INDEX RECEPT_NO ON RO_SLIP_TRN_SALES(RECEPT_NO);
CREATE INDEX SHIP_DATE ON RO_SLIP_TRN_SALES(SHIP_DATE);
CREATE INDEX CUSTOMER_CODE ON RO_SLIP_TRN_SALES(CUSTOMER_CODE);
CREATE INDEX DELIVERY_DATE ON RO_SLIP_TRN_SALES(DELIVERY_DATE);
CREATE INDEX UPD_DATETM ON RO_SLIP_TRN_HIST_SALES(UPD_DATETM);
CREATE INDEX CUSTOMER_CODE ON RO_SLIP_TRN_HIST_SALES(CUSTOMER_CODE);
CREATE INDEX REST_QUANTITY ON RO_LINE_TRN_SALES(REST_QUANTITY);
CREATE INDEX PRODUCT_CODE ON RO_LINE_TRN_SALES(PRODUCT_CODE);
CREATE INDEX LAST_SHIP_DATE ON RO_LINE_TRN_HIST_SALES(LAST_SHIP_DATE);
CREATE INDEX PRODUCT_CODE ON RO_LINE_TRN_HIST_SALES(PRODUCT_CODE);
CREATE INDEX JAN_PCODE ON PRODUCT_MST_SALES(JAN_PCODE);
CREATE INDEX RACK_CODE ON PRODUCT_MST_SALES(RACK_CODE);
CREATE INDEX SUPPLIER_CODE ON PRODUCT_MST_SALES(SUPPLIER_CODE);
CREATE INDEX SUPPLIER_PCODE ON PRODUCT_MST_SALES(SUPPLIER_PCODE);
CREATE INDEX PRODUCT_CODE ON PRODUCT_MST_SALES(PRODUCT_CODE);
CREATE INDEX PRODUCT_1 ON PRODUCT_MST_SALES(PRODUCT_1);
CREATE INDEX PRODUCT_2 ON PRODUCT_MST_SALES(PRODUCT_2);
CREATE INDEX PRODUCT_3 ON PRODUCT_MST_SALES(PRODUCT_3);
CREATE INDEX PO_NUM ON PRODUCT_MST_SALES(PO_NUM);
CREATE INDEX UPD_DATETM ON PRODUCT_MST_HIST_SALES(UPD_DATETM);
CREATE INDEX CRE_DATETM ON PRODUCT_MST_HIST_SALES(CRE_DATETM);
CREATE INDEX PRODUCT_CODE ON PRODUCT_MST_HIST_SALES(PRODUCT_CODE);
CREATE INDEX STOCK_PDATE ON PRODUCT_STOCK_TRN_SALES(STOCK_PDATE);
CREATE INDEX PRODUCT_CODE ON PRODUCT_STOCK_TRN_SALES(PRODUCT_CODE);
CREATE INDEX RACK_CODE ON PRODUCT_STOCK_TRN_SALES(RACK_CODE);
CREATE INDEX STOCK_YM ON PRODUCT_STOCK_TRN_SALES(STOCK_YM);
CREATE INDEX CLASS_CODE_3 ON PRODUCT_CLASS_MST_SALES(CLASS_CODE_3);
CREATE INDEX CLASS_CODE_1 ON PRODUCT_CLASS_MST_SALES(CLASS_CODE_1);
CREATE INDEX CLASS_CODE_2 ON PRODUCT_CLASS_MST_SALES(CLASS_CODE_2);
CREATE INDEX THIS_BILL_PRICE ON BILL_TRN_SALES(THIS_BILL_PRICE);
CREATE INDEX LAST_PRINT_DATE ON BILL_TRN_SALES(LAST_PRINT_DATE);
CREATE INDEX LAST_SALES_DATE ON BILL_TRN_SALES(LAST_SALES_DATE);
CREATE INDEX BILL_ID ON BILL_TRN_SALES(BILL_ID);
CREATE INDEX BILL_CUTOFF_DATE ON BILL_TRN_SALES(BILL_CUTOFF_DATE);
CREATE INDEX CUSTOMER_CODE ON BILL_TRN_SALES(CUSTOMER_CODE);
CREATE INDEX RACK_NAME ON RACK_MST_SALES(RACK_NAME);
CREATE INDEX RACK_CODE ON RACK_MST_SALES(RACK_CODE);
...
CREATE INDEX CUSTOMER_CODE ON CUSTOMER_MST_SALES(CUSTOMER_CODE);
CREATE INDEX CUSTOMER_RANK_CATEGORY ON CUSTOMER_MST_SALES(CUSTOMER_RANK_CATEGORY);
CREATE INDEX CUSTOMER_NAME ON CUSTOMER_MST_SALES(CUSTOMER_NAME);
CREATE INDEX CUSTOMER_TEL ON CUSTOMER_MST_SALES(CUSTOMER_TEL);
CREATE INDEX UPD_DATETM ON CUSTOMER_MST_HIST_SALES(UPD_DATETM);
CREATE INDEX CRE_DATETM ON CUSTOMER_MST_HIST_SALES(CRE_DATETM);
CREATE INDEX CUSTOMER_CODE ON CUSTOMER_MST_HIST_SALES(CUSTOMER_CODE);
CREATE INDEX RANK_CODE ON CUSTOMER_RANK_MST_SALES(RANK_CODE);
CREATE INDEX POSTAGE_TYPE ON CUSTOMER_RANK_MST_SALES(POSTAGE_TYPE);
CREATE INDEX RANK_RATE ON CUSTOMER_RANK_MST_SALES(RANK_RATE);
CREATE INDEX USER_ID ON DEPOSIT_SLIP_TRN_SALES(USER_ID);
CREATE INDEX DEPOSIT_TOTAL ON DEPOSIT_SLIP_TRN_SALES(DEPOSIT_TOTAL);
CREATE INDEX CUSTOMER_CODE ON DEPOSIT_SLIP_TRN_SALES(CUSTOMER_CODE);
CREATE INDEX DEPOSIT_CATEGORY ON DEPOSIT_SLIP_TRN_SALES(DEPOSIT_CATEGORY);
CREATE INDEX DEPOSIT_SLIP_ID ON DEPOSIT_SLIP_TRN_SALES(DEPOSIT_SLIP_ID);
CREATE INDEX DEPOSIT_DATE ON DEPOSIT_SLIP_TRN_SALES(DEPOSIT_DATE);
CREATE INDEX INPUT_PDATE ON DEPOSIT_SLIP_TRN_SALES(INPUT_PDATE);
CREATE INDEX DEPOSIT_SLIP_ID ON DEPOSIT_LINE_TRN_SALES(DEPOSIT_SLIP_ID);
CREATE INDEX UPD_DATETM ON DEPOSIT_SLIP_TRN_HIST_SALES(UPD_DATETM);
CREATE INDEX CUSTOMER_CODE ON DEPOSIT_SLIP_TRN_HIST_SALES(CUSTOMER_CODE);
CREATE INDEX STOCK_PDATE ON EAD_SLIP_TRN_SALES(STOCK_PDATE);
CREATE INDEX SUPPLIER_SLIP_ID ON EAD_SLIP_TRN_SALES(SUPPLIER_SLIP_ID);
CREATE INDEX USER_ID ON EAD_SLIP_TRN_SALES(USER_ID);
CREATE INDEX EAD_SLIP_CATEGORY ON EAD_SLIP_TRN_SALES(EAD_SLIP_CATEGORY);
CREATE INDEX EAD_SLIP_ID ON EAD_SLIP_TRN_SALES(EAD_SLIP_ID);
CREATE INDEX EAD_DATE ON EAD_SLIP_TRN_SALES(EAD_DATE);
CREATE INDEX SALES_SLIP_ID ON EAD_SLIP_TRN_SALES(SALES_SLIP_ID);
CREATE INDEX UPD_DATETM ON EAD_SLIP_TRN_HIST_SALES(UPD_DATETM);
CREATE INDEX EAD_SLIP_CATEGORY ON EAD_SLIP_TRN_HIST_SALES(EAD_SLIP_CATEGORY);
CREATE INDEX PRODUCT_CODE ON EAD_LINE_TRN_SALES(PRODUCT_CODE);
CREATE INDEX EAD_SLIP_ID ON EAD_LINE_TRN_SALES(EAD_SLIP_ID);
CREATE INDEX RACK_CODE ON EAD_LINE_TRN_SALES(RACK_CODE);
CREATE INDEX PRODUCT_CODE ON EAD_LINE_TRN_HIST_SALES(PRODUCT_CODE);
CREATE INDEX SUPPLIER_CODE ON APT_BALANCE_TRN_SALES(SUPPLIER_CODE);
CREATE INDEX APT_YM ON APT_BALANCE_TRN_SALES(APT_YM);
CREATE INDEX CUSTOMER_CODE ON ART_BALANCE_TRN_SALES(CUSTOMER_CODE);
CREATE INDEX ART_YM ON ART_BALANCE_TRN_SALES(ART_YM);
CREATE INDEX RO_SLIP_ID ON SALES_SLIP_TRN_SALES(RO_SLIP_ID);
CREATE INDEX RECEPT_NO ON SALES_SLIP_TRN_SALES(RECEPT_NO);
CREATE INDEX CUSTOMER_CODE ON SALES_SLIP_TRN_SALES(CUSTOMER_CODE);
CREATE INDEX DELIVERY_DATE ON SALES_SLIP_TRN_SALES(DELIVERY_DATE);
CREATE INDEX DC_CATEGORY ON SALES_SLIP_TRN_SALES(DC_CATEGORY);
CREATE INDEX SALES_SLIP_ID ON SALES_SLIP_TRN_SALES(SALES_SLIP_ID);
CREATE INDEX BILL_ID ON SALES_SLIP_TRN_SALES(BILL_ID);
CREATE INDEX SALES_DATE ON SALES_SLIP_TRN_SALES(SALES_DATE);
CREATE INDEX SALES_YM ON SALES_SLIP_TRN_SALES(SALES_YM);
CREATE INDEX UPD_DATETM ON SALES_SLIP_TRN_HIST_SALES(UPD_DATETM);
CREATE INDEX CUSTOMER_CODE ON SALES_SLIP_TRN_HIST_SALES(CUSTOMER_CODE);
CREATE INDEX PRODUCT_CODE ON SALES_LINE_TRN_SALES(PRODUCT_CODE);
CREATE INDEX RO_LINE_ID ON SALES_LINE_TRN_SALES(RO_LINE_ID);
CREATE INDEX PRODUCT_CODE ON SALES_LINE_TRN_HIST_SALES(PRODUCT_CODE);
CREATE INDEX SUPPLIER_CODE ON PO_SLIP_TRN_SALES(SUPPLIER_CODE);
CREATE INDEX DELIVERY_DATE ON PO_SLIP_TRN_SALES(DELIVERY_DATE);
CREATE INDEX PO_SLIP_ID ON PO_SLIP_TRN_SALES(PO_SLIP_ID);
CREATE INDEX PO_DATE ON PO_SLIP_TRN_SALES(PO_DATE);
CREATE INDEX UPD_DATETM ON PO_SLIP_TRN_HIST_SALES(UPD_DATETM);
CREATE INDEX SUPPLIER_CODE ON PO_SLIP_TRN_HIST_SALES(SUPPLIER_CODE);
CREATE INDEX DELIVERY_DATE ON PO_SLIP_TRN_HIST_SALES(DELIVERY_DATE);
CREATE INDEX REST_QUANTITY ON PO_LINE_TRN_SALES(REST_QUANTITY);
CREATE INDEX PRODUCT_CODE ON PO_LINE_TRN_SALES(PRODUCT_CODE);
CREATE INDEX PRODUCT_CODE ON PO_LINE_TRN_HIST_SALES(PRODUCT_CODE);
CREATE INDEX PARENT_ID ON DEPT_MST_SALES(PARENT_ID);
CREATE INDEX DEPT_ID ON DEPT_MST_SALES(DEPT_ID);
CREATE INDEX ZIP_CODE ON ZIP_MST_SALES(ZIP_CODE);
...
CREATE INDEX ADJUST_NAME_ID ON CUSTOMER_SALES_TEMP_SALES(ADJUST_NAME_ID);
CREATE INDEX CUSTOMER_NAME ON CUSTOMER_SALES_TEMP_SALES(CUSTOMER_NAME);
CREATE INDEX CUSTOMER_TEL ON CUSTOMER_SALES_TEMP_SALES(CUSTOMER_TEL);

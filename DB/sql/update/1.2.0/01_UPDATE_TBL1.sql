ALTER TABLE MINE_MST_SALES ADD COMPANY_CEO_TITLE VARCHAR(20);
ALTER TABLE MINE_MST_HIST_SALES ADD COMPANY_CEO_TITLE VARCHAR(20);

UPDATE MINE_MST_SALES SET COMPANY_CEO_TITLE = '代表取締役社長';
commit;
